...
class ProductsInCart(BaseTest):
    ...
    def test_add_to_cart(self):
        ...
        self.wait.until( EC.element_to_be_clickable((By.NAME, "update_cart")) ).click()

        # 8. Check expected result - product is not visible in a cart anymore
        updated_qty = self.wait.until(
            EC.visibility_of_element_located((By.CSS_SELECTOR, "input.qty")) ).get_attribute("value")
